...
% C es el factor de correcci�n
% Para un filtro de una sola pasada C=1
% en general C = (2^(1/n)-1)^0.25, donde n es el n�mero de pasadas
...
% Debido a las caracter�sticas de retardo de fase del filtro, 
% se realiza un segundo refiltrado en la direcci�n inversa en el tiempo, 
